...
class StoryFreeUsageManager {
  ...
  /// Give the free generation back only when the API failed to start.
  static Future<void> restoreFreeStoryIfApiDidNotStart() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setInt(_storyCountKey, 0);
  }
